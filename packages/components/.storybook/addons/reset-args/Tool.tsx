// From https://github.com/melrose13-69/storybook-reset-url-args
import * as React from 'react';
import { IconButton } from '@storybook/components';

/** A toolbar icon to toggle between dark and light themes in storybook */
export const ResetUrlArgsComponent = () => {
  const resetUrl = (): void => {
  ...
  return (
    <IconButton key="reset-url-args" title="Reset components arguments (&args=) from url" onClick={resetUrl}>
      <ResetIcon />
    </IconButton>
  );
};
...
const ResetIcon = () => (
  <svg version="1.1" id="Capa_1" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 425.466 425.467" style={{ fill: 'currentColor' }}>
    <path
    ...
    />
    <path
      d="M343.466,261.465c-45.287,0-82,36.713-82,82s36.713,82,82,82c45.286,0,82-36.713,82-82S388.753,261.465,343.466,261.465z
...
export default ResetUrlArgsComponent;
